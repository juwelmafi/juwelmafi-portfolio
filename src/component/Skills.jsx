...
const Skills = () => {
  return (
    <section id='skills' className="bg-[#323647] text-white py-16 px-4 md:px-20 font-[Poppins]">
      <div className="max-w-6xl mx-auto text-center">
        {/* Section Heading */}
        <h2 className="text-2xl md:text-4xl font-bold mb-4">My Skills</h2>
        <p className="text-[#FDCB6E] uppercase text-sm md:text-base tracking-widest mb-10">Tools & Technologies I Use</p>
